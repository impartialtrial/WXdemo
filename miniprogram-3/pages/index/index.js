...
//path
const envPath = 'http://10.2.108.211/web3/samples/default_env';
const env = 'default_env';
const assetsPath = `http://10.2.108.211/web3/samples/Dz/assets`
...
let dancing_url= `${modelsPath}/dancing/dancing.glb`
...
const imageMaterial = `http://10.2.108.211/web3/samples/materials/image.filamat`
const image1 = `${modelsPath}/1.png`
    ...
    query.select('#myCanvas').node().exec((res) => {
      ...
      class App {
        constructor(canvas) {
            ...
            const asset = this.asset = this.loader.createAsset(dancing_url);
            ...
            this.asset.loadResources(onDone, onFetched, dancing_url);
      ...
      var CTEngine = null;
      require('../CTEngine-js/engine.js', (res) => {
        CTEngine = res
        require('../CTEngine-js/gltumble.min.js', (res) => {
          require('../CTEngine-js/gl-matrix-min.js', (res) => {
            CTEngine.init([dancing_url, ibl_url, sky_url, blink_dat, phone_to_bs_mean_1_txt, settingJson, default_settingJson, imageMaterial, image1], () => {
