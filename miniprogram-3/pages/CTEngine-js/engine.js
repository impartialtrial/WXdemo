  ...
  return function (CTEngine) {
    ...
    function createWasm() {
      ...
      function instantiateArrayBuffer(receiver) {
        return WXWebAssembly.instantiate("/engine.wasm.br", info)
    ...
    function createNamedFunction(name, humanName, body) {
      ...
      switch(humanName) {
      case 'constructor$RegistryKeys': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$RegistryKeys() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor RegistryKeys called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        ...
        case 'constructor$EntityVector': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$EntityVector() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor EntityVector called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'constructor$AssetInstanceVector': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$AssetInstanceVector() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor AssetInstanceVector called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'constructor$MaterialInstanceVector': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$MaterialInstanceVector() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor MaterialInstanceVector called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        if (arguments.length !== 0) {
        throwBindingError('function Engine._create called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'Engine$getSupportedFeatureLevel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$getSupportedFeatureLevel() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.getSupportedFeatureLevel called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        ...
        case 'Engine$setActiveFeatureLevel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$setActiveFeatureLevel(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.setActiveFeatureLevel called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$getActiveFeatureLevel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$getActiveFeatureLevel() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.getActiveFeatureLevel called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Engine$createSwapChain': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$createSwapChain() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.createSwapChain called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Engine$createRenderer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$createRenderer() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.createRenderer called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        if (arguments.length !== 0) {
        throwBindingError('function Engine.createView called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'View$getBlendMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function View$getBlendMode() {
        if (arguments.length !== 0) {
        throwBindingError('function View.getBlendMode called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'View$getAmbientOcclusion': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function View$getAmbientOcclusion() {
        if (arguments.length !== 0) {
        throwBindingError('function View.getAmbientOcclusion called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'View$getAntiAliasing': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function View$getAntiAliasing() {
        if (arguments.length !== 0) {
        throwBindingError('function View.getAntiAliasing called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Engine$createScene': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$createScene() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.createScene called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getFrustum': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getFrustum() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getFrustum called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'ColorGrading$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function ColorGrading$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function ColorGrading.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'ColorGrading$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'ColorGrading$Builder$quality': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$quality(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.quality called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'ColorGrading$Builder$format': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$format(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.format called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'ColorGrading$Builder$toneMapping': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$toneMapping(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.toneMapping called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderTarget$Builder$face': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderTarget$Builder$face(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderTarget$Builder.face called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderTarget$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderTarget$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderTarget$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderTarget$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function RenderTarget$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function RenderTarget.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'RenderTarget$getFace': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderTarget$getFace(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderTarget.getFace called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget$AttachmentPoint
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Engine$getRenderableManager': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$getRenderableManager() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.getRenderableManager called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Engine$getTransformManager': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$getTransformManager() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.getTransformManager called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'TransformManager$getChildren': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$getChildren(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.getChildren called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$getLightManager': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$getLightManager() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.getLightManager called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'LightManager$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.Builder called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        ...
        case 'LightManager$getType': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getType(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getType called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'BufferObject$Builder$bindingType': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function BufferObject$Builder$bindingType(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function BufferObject$Builder.bindingType called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'BufferObject$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function BufferObject$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function BufferObject$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'BufferObject$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function BufferObject$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function BufferObject.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'VertexBuffer$Builder$normalized': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function VertexBuffer$Builder$normalized(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function VertexBuffer$Builder.normalized called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'VertexBuffer$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function VertexBuffer$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function VertexBuffer$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'VertexBuffer$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function VertexBuffer$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function VertexBuffer.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'IndexBuffer$Builder$bufferType': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndexBuffer$Builder$bufferType(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndexBuffer$Builder.bufferType called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'IndexBuffer$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndexBuffer$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndexBuffer$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'IndexBuffer$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function IndexBuffer$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function IndexBuffer.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'Material$getDefaultInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Material$getDefaultInstance() {
        if (arguments.length !== 0) {
        throwBindingError('function Material.getDefaultInstance called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Material$createInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Material$createInstance() {
        if (arguments.length !== 0) {
        throwBindingError('function Material.createInstance called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$getTransparencyMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$getTransparencyMode() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.getTransparencyMode called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$getCullingMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$getCullingMode() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.getCullingMode called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$TextureSampler': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function constructor$TextureSampler(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function constructor TextureSampler called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        ...
        case 'RenderTarget$Builder$texture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderTarget$Builder$texture(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderTarget$Builder.texture called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget$AttachmentPoint
        ...
        case 'Texture$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Texture$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function Texture.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'Texture$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Texture$Builder$sampler': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$sampler(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.sampler called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Texture$Builder$format': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$format(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.format called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Scene$getIndirectLight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Scene$getIndirectLight() {
        if (arguments.length !== 0) {
        throwBindingError('function Scene.getIndirectLight called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'IndirectLight$getReflectionsTexture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function IndirectLight$getReflectionsTexture() {
        if (arguments.length !== 0) {
        throwBindingError('function IndirectLight.getReflectionsTexture called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'IndirectLight$getIrradianceTexture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function IndirectLight$getIrradianceTexture() {
        if (arguments.length !== 0) {
        throwBindingError('function IndirectLight.getIrradianceTexture called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'IndirectLight$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function IndirectLight$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function IndirectLight.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'IndirectLight$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndirectLight$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'IndirectLight$Builder$reflections': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndirectLight$Builder$reflections(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight$Builder.reflections called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'IndirectLight$Builder$irradianceTex': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndirectLight$Builder$irradianceTex(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight$Builder.irradianceTex called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Texture const*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Scene$getSkybox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Scene$getSkybox() {
        if (arguments.length !== 0) {
        throwBindingError('function Scene.getSkybox called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Skybox$getTexture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Skybox$getTexture() {
        if (arguments.length !== 0) {
        throwBindingError('function Skybox.getTexture called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        if (arguments.length !== 0) {
        throwBindingError('function Skybox.Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'Skybox$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Skybox$Builder$_build(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Skybox$Builder._build called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Skybox$Builder$environment': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Skybox$Builder$environment(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Skybox$Builder.environment called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$createCamera': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$createCamera(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.createCamera called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$getCameraComponent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$getCameraComponent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.getCameraComponent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$getInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$getInstance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.getInstance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$getInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$getInstance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.getInstance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$getParent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$getParent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.getParent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // TransformManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$getInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getInstance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getInstance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Engine$getEntityManager': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$getEntityManager() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.getEntityManager called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'EntityManager$get': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function EntityManager$get() {
        if (arguments.length !== 0) {
        throwBindingError('function EntityManager.get called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'EntityManager$create': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function EntityManager$create() {
        if (arguments.length !== 0) {
        throwBindingError('function EntityManager.create called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Engine$_createMaterial': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$_createMaterial(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine._createMaterial called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'constructor$Ktx1Bundle': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function constructor$Ktx1Bundle(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function constructor Ktx1Bundle called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$getPixelDataFormat': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$getPixelDataFormat() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.getPixelDataFormat called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$getPixelDataType': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$getPixelDataType() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.getPixelDataType called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$getCompressedPixelDataType': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$getCompressedPixelDataType() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.getCompressedPixelDataType called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx2Reader$requestFormat': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Ktx2Reader$requestFormat(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Ktx2Reader.requestFormat called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Texture$InternalFormat
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Ktx2Reader$load': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function Ktx2Reader$load(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function Ktx2Reader.load called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        ...
        case 'Ktx1Bundle$info': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$info() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.info called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$MeshReader$MaterialRegistry': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$MeshReader$MaterialRegistry() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor MeshReader$MaterialRegistry called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'MeshReader$MaterialRegistry$keys': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MeshReader$MaterialRegistry$keys() {
        if (arguments.length !== 0) {
        throwBindingError('function MeshReader$MaterialRegistry.keys called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MeshReader$loadMeshFromBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function MeshReader$loadMeshFromBuffer(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function MeshReader.loadMeshFromBuffer called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'MeshReader$Mesh$renderable': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MeshReader$Mesh$renderable() {
        if (arguments.length !== 0) {
        throwBindingError('function MeshReader$Mesh.renderable called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MeshReader$Mesh$vertexBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MeshReader$Mesh$vertexBuffer() {
        if (arguments.length !== 0) {
        throwBindingError('function MeshReader$Mesh.vertexBuffer called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MeshReader$Mesh$indexBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MeshReader$Mesh$indexBuffer() {
        if (arguments.length !== 0) {
        throwBindingError('function MeshReader$Mesh.indexBuffer called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$SurfaceOrientation$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$SurfaceOrientation$Builder() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor SurfaceOrientation$Builder called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'SurfaceOrientation$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function SurfaceOrientation$Builder$_build() {
        if (arguments.length !== 0) {
        throwBindingError('function SurfaceOrientation$Builder._build called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$gltfio$FileLoader': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$gltfio$FileLoader() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor gltfio$FileLoader called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'gltfio$CTEngineAsset$_getEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$_getEntities() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset._getEntities called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$_getLightEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$_getLightEntities() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset._getLightEntities called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$_getRenderableEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$_getRenderableEntities() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset._getRenderableEntities called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$_getCameraEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$_getCameraEntities() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset._getCameraEntities called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$getRoot': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$getRoot() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.getRoot called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$popRenderable': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$popRenderable() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.popRenderable called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$_getAssetInstances': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$_getAssetInstances() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset._getAssetInstances called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$_getResourceUris': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$_getResourceUris() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset._getResourceUris called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$getWireframe': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$getWireframe() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.getWireframe called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$getEngine': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$getEngine() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.getEngine called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineAsset$getInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$getInstance() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.getInstance called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getAsset': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getAsset() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getAsset called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getEntities() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getEntities called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getRoot': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getRoot() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getRoot called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getAnimator': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getAnimator() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getAnimator called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getAvatar': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getAvatar() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getAvatar called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getFileLoader': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getFileLoader() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getFileLoader called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getSkinNames': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getSkinNames() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getSkinNames called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$getMaterialInstances': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$getMaterialInstances() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance.getMaterialInstances called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$_getMaterialVariantNames': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineInstance$_getMaterialVariantNames() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineInstance._getMaterialVariantNames called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$gltfio$UbershaderProvider': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function constructor$gltfio$UbershaderProvider(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function constructor gltfio$UbershaderProvider called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$gltfio$StbProvider': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function constructor$gltfio$StbProvider(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function constructor gltfio$StbProvider called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$gltfio$Ktx2Provider': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function constructor$gltfio$Ktx2Provider(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function constructor gltfio$Ktx2Provider called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$gltfio$AssetLoader': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function constructor$gltfio$AssetLoader(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function constructor gltfio$AssetLoader called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'gltfio$AssetLoader$_createAsset': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$AssetLoader$_createAsset(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$AssetLoader._createAsset called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$AssetLoader$createInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$AssetLoader$createInstance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$AssetLoader.createInstance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'constructor$CTScene': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3
        ) {
        return function constructor$CTScene(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function constructor CTScene called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'constructor$JsonSerializer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function constructor$JsonSerializer() {
        if (arguments.length !== 0) {
        throwBindingError('function constructor JsonSerializer called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var rv = invoker(fn);
        var ret = retType.fromWireType(rv);
        return ret;
        ...
        case 'ViewerGui$getSettings': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function ViewerGui$getSettings() {
        if (arguments.length !== 0) {
        throwBindingError('function ViewerGui.getSettings called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'EntityVector$push_back': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function EntityVector$push_back(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function EntityVector.push_back called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        ...
        case 'AssetInstanceVector$push_back': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function AssetInstanceVector$push_back(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function AssetInstanceVector.push_back called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'MaterialInstanceVector$push_back': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstanceVector$push_back(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstanceVector.push_back called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$enableAccurateTranslations': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$enableAccurateTranslations() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.enableAccurateTranslations called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$_execute': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$_execute() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine._execute called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroy called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'Engine$destroySwapChain': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroySwapChain(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroySwapChain called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyRenderer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyRenderer(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyRenderer called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyView': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyView(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyView called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyScene': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyScene(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyScene called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyCameraComponent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyCameraComponent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyCameraComponent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Engine$destroyMaterial': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyMaterial(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyMaterial called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyEntity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyEntity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyEntity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Engine$destroyColorGrading': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyColorGrading(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyColorGrading called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyIndexBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyIndexBuffer(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyIndexBuffer called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyIndirectLight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyIndirectLight(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyIndirectLight called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyMaterialInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyMaterialInstance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyMaterialInstance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyRenderTarget': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyRenderTarget(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyRenderTarget called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroySkybox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroySkybox(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroySkybox called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$destroyTexture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyTexture(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyTexture called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Texture*
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Engine$destroyVertexBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$destroyVertexBuffer(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.destroyVertexBuffer called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Renderer$renderView': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Renderer$renderView(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Renderer.renderView called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Renderer$renderStandaloneView': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Renderer$renderStandaloneView(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Renderer.renderStandaloneView called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // View const*
        invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 2) {
        throwBindingError('function Renderer.render called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // SwapChain*
        var arg1Wired = argType1.toWireType(null, arg1); // View*
        ...
        case 'Renderer$endFrame': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Renderer$endFrame() {
        if (arguments.length !== 0) {
        throwBindingError('function Renderer.endFrame called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        if (arguments.length !== 1) {
        throwBindingError('function View.setScene called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Scene*
        invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 1) {
        throwBindingError('function View.setCamera called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$setColorGrading': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setColorGrading(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setColorGrading called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // ColorGrading*
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$setBlendMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setBlendMode(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setBlendMode called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$setAmbientOcclusion': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setAmbientOcclusion(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setAmbientOcclusion called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$setAntiAliasing': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setAntiAliasing(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setAntiAliasing called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$setRenderTarget': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setRenderTarget(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setRenderTarget called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget*
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Scene$addEntity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Scene$addEntity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Scene.addEntity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Scene$_addEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Scene$_addEntities(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Scene._addEntities called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Scene$_removeEntities': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Scene$_removeEntities(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Scene._removeEntities called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // EntityVector
        invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 1) {
        throwBindingError('function Scene.remove called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Scene$setSkybox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Scene$setSkybox(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Scene.setSkybox called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Skybox*
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Scene$setIndirectLight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Scene$setIndirectLight(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Scene.setIndirectLight called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // IndirectLight*
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$destroy': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$destroy(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.destroy called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$create': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$create(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.create called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$destroy': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$destroy(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.destroy called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$setParent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function TransformManager$setParent(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function TransformManager.setParent called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // TransformManager$Instance
        ...
        case 'TransformManager$openLocalTransformTransaction': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function TransformManager$openLocalTransformTransaction() {
        if (arguments.length !== 0) {
        throwBindingError('function TransformManager.openLocalTransformTransaction called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'TransformManager$commitLocalTransformTransaction': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function TransformManager$commitLocalTransformTransaction() {
        if (arguments.length !== 0) {
        throwBindingError('function TransformManager.commitLocalTransformTransaction called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'MaterialInstance$setTransparencyMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setTransparencyMode(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setTransparencyMode called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'MaterialInstance$setCullingMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setCullingMode(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setCullingMode called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'MaterialInstance$setStencilCompareFunction': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilCompareFunction(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilCompareFunction called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilCompareFunction called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // CompareFunc
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setStencilOpStencilFail': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilOpStencilFail(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilOpStencilFail called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilOpStencilFail called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // StencilOperation
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setStencilOpDepthFail': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilOpDepthFail(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilOpDepthFail called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // StencilOperation
        var arg1Wired = argType1.toWireType(null, arg1); // StencilFace
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilOpDepthFail called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // StencilOperation
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setStencilOpDepthStencilPass': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilOpDepthStencilPass(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilOpDepthStencilPass called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // StencilOperation
        var arg1Wired = argType1.toWireType(null, arg1); // StencilFace
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilOpDepthStencilPass called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // StencilOperation
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'TextureSampler$setCompareMode': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function TextureSampler$setCompareMode(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function TextureSampler.setCompareMode called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Texture$generateMipmaps': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$generateMipmaps(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture.generateMipmaps called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'EntityManager$destroy': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function EntityManager$destroy(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function EntityManager.destroy called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Ktx2Reader$unrequestFormat': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Ktx2Reader$unrequestFormat(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Ktx2Reader.unrequestFormat called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Texture$InternalFormat
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$Animator$updateBoneMatrices': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$Animator$updateBoneMatrices() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$Animator.updateBoneMatrices called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'gltfio$Animator$resetBoneMatrices': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$Animator$resetBoneMatrices() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$Animator.resetBoneMatrices called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'gltfio$FileLoader$test': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$FileLoader$test(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$FileLoader.test called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'gltfio$FileLoader$applyAnimation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$FileLoader$applyAnimation(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$FileLoader.applyAnimation called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // gltfio$CTEngineAsset*
        ...
        case 'gltfio$CTEngineAsset$releaseSourceData': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$releaseSourceData() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.releaseSourceData called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'gltfio$CTEngineInstance$createAvatar': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$CTEngineInstance$createAvatar(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$CTEngineInstance.createAvatar called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // gltfio$CTEngineAsset*
        ...
        case 'gltfio$UbershaderProvider$destroyMaterials': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$UbershaderProvider$destroyMaterials() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$UbershaderProvider.destroyMaterials called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'gltfio$AssetLoader$destroyAsset': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$AssetLoader$destroyAsset(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$AssetLoader.destroyAsset called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'gltfio$ResourceLoader$asyncUpdateLoad': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$ResourceLoader$asyncUpdateLoad() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$ResourceLoader.asyncUpdateLoad called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'CTAnimator$updateBoneMatrices': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function CTAnimator$updateBoneMatrices(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function CTAnimator.updateBoneMatrices called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'CTScene$addBackground': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function CTScene$addBackground() {
        if (arguments.length !== 0) {
        throwBindingError('function CTScene.addBackground called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        invoker(fn, thisWired);
        }
        ...
        case 'applySettings(arg0, arg1, arg2, arg3, arg4)': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4
        ) {
        return function applySettings(arg0, arg1, arg2, arg3, arg4) {
        if (arguments.length !== 5) {
        throwBindingError('function applySettings called with ' + arguments.length + ' arguments, expected 5 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'applySettings(arg0, arg1, arg2)': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function applySettings(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function applySettings called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // ViewerGui*
        ...
        case 'applySettings(arg0, arg1, arg2, arg3, arg4, arg5, arg6)': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4,argType5,argType6
        ) {
        return function applySettings(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
        if (arguments.length !== 7) {
        throwBindingError('function applySettings called with ' + arguments.length + ' arguments, expected 7 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // ViewerGui*
        ...
        invoker(fn, arg0Wired, arg1Wired, arg2Wired, arg3Wired, arg4Wired, arg5Wired, arg6Wired);
        }
        ...
        if (arguments.length !== 3) {
        throwBindingError('function applyColorGrading called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // ViewerGui*
        var arg2Wired = argType2.toWireType(null, arg2); // View*
        ...
        case 'Engine$setAutomaticInstancingEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Engine$setAutomaticInstancingEnabled(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Engine.setAutomaticInstancingEnabled called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Engine$isAutomaticInstancingEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Engine$isAutomaticInstancingEnabled() {
        if (arguments.length !== 0) {
        throwBindingError('function Engine.isAutomaticInstancingEnabled called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'SwapChain$isSRGBSwapChainSupported': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function SwapChain$isSRGBSwapChainSupported(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function SwapChain.isSRGBSwapChainSupported called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Renderer$beginFrame': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Renderer$beginFrame(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Renderer.beginFrame called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // SwapChain*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$setPostProcessingEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setPostProcessingEnabled(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setPostProcessingEnabled called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$setStencilBufferEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setStencilBufferEnabled(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setStencilBufferEnabled called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$isStencilBufferEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function View$isStencilBufferEnabled() {
        if (arguments.length !== 0) {
        throwBindingError('function View.isStencilBufferEnabled called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Scene$hasEntity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Scene$hasEntity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Scene.hasEntity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'ColorGrading$Builder$luminanceScaling': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$luminanceScaling(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.luminanceScaling called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'ColorGrading$Builder$gamutMapping': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$gamutMapping(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.gamutMapping called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$culling': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$culling(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.culling called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$castShadows': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$castShadows(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.castShadows called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$receiveShadows': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$receiveShadows(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.receiveShadows called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$morphing': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$morphing(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.morphing called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$hasComponent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$hasComponent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.hasComponent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$setCastShadows': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$setCastShadows(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.setCastShadows called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderableManager$setReceiveShadows': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$setReceiveShadows(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.setReceiveShadows called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        ...
        case 'RenderableManager$isShadowCaster': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$isShadowCaster(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.isShadowCaster called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$isShadowReceiver': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$isShadowReceiver(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.isShadowReceiver called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$hasComponent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$hasComponent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.hasComponent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$castShadows': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$castShadows(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.castShadows called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$castLight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$castLight(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.castLight called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$hasComponent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$hasComponent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.hasComponent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$isDirectional': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$isDirectional(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.isDirectional called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$isPointLight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$isPointLight(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.isPointLight called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$isSpotLight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$isSpotLight(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.isSpotLight called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setShadowCaster': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$setShadowCaster(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setShadowCaster called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        ...
        case 'LightManager$isShadowCaster': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$isShadowCaster(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.isShadowCaster called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'VertexBuffer$Builder$enableBufferObjects': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function VertexBuffer$Builder$enableBufferObjects(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function VertexBuffer$Builder.enableBufferObjects called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'VertexBuffer$Builder$normalizedIf': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function VertexBuffer$Builder$normalizedIf(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function VertexBuffer$Builder.normalizedIf called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // VertexAttribute
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        ...
        case 'MaterialInstance$setDoubleSided': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setDoubleSided(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setDoubleSided called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$isDoubleSided': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$isDoubleSided() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.isDoubleSided called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$setColorWrite': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setColorWrite(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setColorWrite called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$isColorWriteEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$isColorWriteEnabled() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.isColorWriteEnabled called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$setDepthWrite': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setDepthWrite(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setDepthWrite called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$isDepthWriteEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$isDepthWriteEnabled() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.isDepthWriteEnabled called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$setStencilWrite': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setStencilWrite(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilWrite called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setDepthCulling': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setDepthCulling(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setDepthCulling called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$isDepthCullingEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$isDepthCullingEnabled() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.isDepthCullingEnabled called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Skybox$Builder$showSun': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Skybox$Builder$showSun(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Skybox$Builder.showSun called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Ktx1Bundle$getInternalFormat': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Ktx1Bundle$getInternalFormat(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Ktx1Bundle.getInternalFormat called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Ktx1Bundle$isCompressed': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$isCompressed() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.isCompressed called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$isCubemap': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$isCubemap() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.isCubemap called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'ktx1reader$createTexture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function ktx1reader$createTexture(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function ktx1reader$createTexture called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'constructor$Ktx2Reader': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function constructor$Ktx2Reader(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function constructor Ktx2Reader called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        var rv = invoker(fn, arg0Wired, arg1Wired);
        ...
        case 'gltfio$Avatar$SetIsLoop': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$Avatar$SetIsLoop(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$Avatar.SetIsLoop called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // bool
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'constructor$gltfio$ResourceLoader': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function constructor$gltfio$ResourceLoader(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function constructor gltfio$ResourceLoader called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        var rv = invoker(fn, arg0Wired, arg1Wired);
        ...
        case 'gltfio$ResourceLoader$loadResources': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$ResourceLoader$loadResources(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$ResourceLoader.loadResources called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // gltfio$CTEngineAsset*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$ResourceLoader$asyncBeginLoad': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$ResourceLoader$asyncBeginLoad(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$ResourceLoader.asyncBeginLoad called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // gltfio$CTEngineAsset*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'CTScene$createBackground': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function CTScene$createBackground(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function CTScene.createBackground called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Material*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$_setGuardBandOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setGuardBandOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setGuardBandOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$setVisibleLayers': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function View$setVisibleLayers(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function View.setVisibleLayers called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$setSampleCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function View$setSampleCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View.setSampleCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$getSampleCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function View$getSampleCount() {
        if (arguments.length !== 0) {
        throwBindingError('function View.getSampleCount called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'ColorGrading$Builder$dimensions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$dimensions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.dimensions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderTarget$Builder$mipLevel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderTarget$Builder$mipLevel(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderTarget$Builder.mipLevel called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget$AttachmentPoint
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'RenderTarget$getMipLevel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderTarget$getMipLevel(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderTarget.getMipLevel called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget$AttachmentPoint
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$layerMask': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$Builder$layerMask(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager$Builder.layerMask called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'RenderableManager$Builder$priority': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$priority(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.priority called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$channel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$channel(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.channel called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$setLayerMask': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setLayerMask(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setLayerMask called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'RenderableManager$setPriority': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$setPriority(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.setPriority called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'RenderableManager$setChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$setChannel(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.setChannel called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'VertexBuffer$setBufferObjectAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function VertexBuffer$setBufferObjectAt(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function VertexBuffer.setBufferObjectAt called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'MaterialInstance$setStencilReferenceValue': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilReferenceValue(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilReferenceValue called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var arg1Wired = argType1.toWireType(null, arg1); // StencilFace
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilReferenceValue called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setStencilReadMask': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilReadMask(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilReadMask called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var arg1Wired = argType1.toWireType(null, arg1); // StencilFace
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilReadMask called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setStencilWriteMask': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setStencilWriteMask(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setStencilWriteMask called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var arg1Wired = argType1.toWireType(null, arg1); // StencilFace
        ...
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setStencilWriteMask called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Texture$_setImage': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function Texture$_setImage(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function Texture._setImage called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'Texture$_setImageCube': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function Texture$_setImageCube(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function Texture._setImageCube called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'Texture$Builder$levels': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$levels(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.levels called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Texture$Builder$usage': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$usage(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.usage called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'View$_setMultiSampleAntiAliasingOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setMultiSampleAntiAliasingOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setMultiSampleAntiAliasingOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderableManager$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$Builder$_build(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager$Builder._build called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'RenderableManager$Builder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.Builder called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        ...
        case 'LightManager$Builder$_build': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$Builder$_build(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager$Builder._build called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // Entity
        ...
        case 'BufferObject$Builder$size': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function BufferObject$Builder$size(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function BufferObject$Builder.size called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'VertexBuffer$Builder$vertexCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function VertexBuffer$Builder$vertexCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function VertexBuffer$Builder.vertexCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'VertexBuffer$Builder$bufferCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function VertexBuffer$Builder$bufferCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function VertexBuffer$Builder.bufferCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'IndexBuffer$Builder$indexCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndexBuffer$Builder$indexCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndexBuffer$Builder.indexCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 2) {
        throwBindingError('function decodeImage called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        ...
        case 'gltfio$AssetLoader$_createInstancedAsset': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$AssetLoader$_createInstancedAsset(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$AssetLoader._createInstancedAsset called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        var arg1Wired = argType1.toWireType(null, arg1); // int
        ...
        case 'constructor$ViewerGui': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3
        ) {
        return function constructor$ViewerGui(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function constructor ViewerGui called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        ...
        case 'ViewerGui$keyDownEvent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ViewerGui$keyDownEvent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ViewerGui.keyDownEvent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'ViewerGui$keyUpEvent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ViewerGui$keyUpEvent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ViewerGui.keyUpEvent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'ViewerGui$keyPressEvent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ViewerGui$keyPressEvent(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ViewerGui.keyPressEvent called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // int
        invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 1) {
        throwBindingError('function View.setViewport called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$getViewport': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function View$getViewport() {
        if (arguments.length !== 0) {
        throwBindingError('function View.getViewport called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$_getBlob': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Ktx1Bundle$_getBlob(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Ktx1Bundle._getBlob called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderTarget$Builder$layer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderTarget$Builder$layer(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderTarget$Builder.layer called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget$AttachmentPoint
        ...
        case 'RenderTarget$getLayer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderTarget$getLayer(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderTarget.getLayer called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderTarget$AttachmentPoint
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$lightChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$Builder$lightChannel(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager$Builder.lightChannel called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderableManager$setLightChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setLightChannel(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setLightChannel called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned int
        ...
        case 'RenderableManager$getLightChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$getLightChannel(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.getLightChannel called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned int
        ...
        case 'LightManager$Builder$lightChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$Builder$lightChannel(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager$Builder.lightChannel called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        ...
        case 'LightManager$setLightChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function LightManager$setLightChannel(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function LightManager.setLightChannel called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned int
        ...
        case 'LightManager$getLightChannel': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$getLightChannel(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.getLightChannel called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned int
        ...
        case 'BufferObject$_setBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function BufferObject$_setBuffer(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function BufferObject._setBuffer called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // driver$BufferDescriptor
        ...
        case 'VertexBuffer$Builder$attribute': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4
        ) {
        return function VertexBuffer$Builder$attribute(arg0, arg1, arg2, arg3, arg4) {
        if (arguments.length !== 5) {
        throwBindingError('function VertexBuffer$Builder.attribute called with ' + arguments.length + ' arguments, expected 5 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // VertexAttribute
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        var rv = invoker(fn, thisWired, arg0Wired, arg1Wired, arg2Wired, arg3Wired, arg4Wired);
        var ret = retType.fromWireType(rv);
        return ret;
        }
        
        }}break;
        case 'VertexBuffer$_setBufferAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3
        ) {
        return function VertexBuffer$_setBufferAt(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function VertexBuffer._setBufferAt called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'IndexBuffer$_setBuffer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function IndexBuffer$_setBuffer(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function IndexBuffer._setBuffer called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // driver$BufferDescriptor
        ...
        case 'Texture$Builder$width': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$width(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.width called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Texture$Builder$height': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$height(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.height called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Texture$Builder$depth': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$Builder$depth(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture$Builder.depth called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 0) {
        throwBindingError('function Entity.getId called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$driver$BufferDescriptor': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function constructor$driver$BufferDescriptor(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function constructor driver$BufferDescriptor called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'constructor$driver$PixelBufferDescriptor': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function constructor$driver$PixelBufferDescriptor(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function constructor driver$PixelBufferDescriptor called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        ...
        return function constructor$driver$PixelBufferDescriptor(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function constructor driver$PixelBufferDescriptor called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        ...
        case 'Ktx1Bundle$getNumMipLevels': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$getNumMipLevels() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.getNumMipLevels called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$getArrayLength': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Ktx1Bundle$getArrayLength() {
        if (arguments.length !== 0) {
        throwBindingError('function Ktx1Bundle.getArrayLength called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Ktx1Bundle$_getCubeBlob': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Ktx1Bundle$_getCubeBlob(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Ktx1Bundle._getCubeBlob called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'SurfaceOrientation$Builder$_normals': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function SurfaceOrientation$Builder$_normals(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function SurfaceOrientation$Builder._normals called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'SurfaceOrientation$Builder$_tangents': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function SurfaceOrientation$Builder$_tangents(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function SurfaceOrientation$Builder._tangents called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // long
        var arg1Wired = argType1.toWireType(null, arg1); // int
        ...
        case 'SurfaceOrientation$Builder$_uvs': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function SurfaceOrientation$Builder$_uvs(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function SurfaceOrientation$Builder._uvs called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // long
        var arg1Wired = argType1.toWireType(null, arg1); // int
        ...
        case 'SurfaceOrientation$Builder$_positions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function SurfaceOrientation$Builder$_positions(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function SurfaceOrientation$Builder._positions called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // long
        var arg1Wired = argType1.toWireType(null, arg1); // int
        ...
        case 'SurfaceOrientation$Builder$_triangles16': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function SurfaceOrientation$Builder$_triangles16(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function SurfaceOrientation$Builder._triangles16 called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'SurfaceOrientation$Builder$_triangles32': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function SurfaceOrientation$Builder$_triangles32(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function SurfaceOrientation$Builder._triangles32 called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RegistryKeys$size': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function RegistryKeys$size() {
        if (arguments.length !== 0) {
        throwBindingError('function RegistryKeys.size called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'EntityVector$resize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function EntityVector$resize(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function EntityVector.resize called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'EntityVector$size': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function EntityVector$size() {
        if (arguments.length !== 0) {
        throwBindingError('function EntityVector.size called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'EntityVector$set': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function EntityVector$set(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function EntityVector.set called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // Entity
        ...
        case 'AssetInstanceVector$resize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function AssetInstanceVector$resize(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function AssetInstanceVector.resize called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        ...
        case 'AssetInstanceVector$size': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function AssetInstanceVector$size() {
        if (arguments.length !== 0) {
        throwBindingError('function AssetInstanceVector.size called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'AssetInstanceVector$set': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function AssetInstanceVector$set(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function AssetInstanceVector.set called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // gltfio$CTEngineInstance*
        ...
        case 'MaterialInstanceVector$resize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstanceVector$resize(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstanceVector.resize called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        ...
        case 'MaterialInstanceVector$size': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstanceVector$size() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstanceVector.size called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstanceVector$set': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstanceVector$set(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstanceVector.set called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // MaterialInstance const*
        ...
        case 'Scene$getRenderableCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Scene$getRenderableCount() {
        if (arguments.length !== 0) {
        throwBindingError('function Scene.getRenderableCount called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Scene$getLightCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Scene$getLightCount() {
        if (arguments.length !== 0) {
        throwBindingError('function Scene.getLightCount called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'RenderableManager$Builder$geometry': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3
        ) {
        return function RenderableManager$Builder$geometry(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function RenderableManager$Builder.geometry called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        ...
        var rv = invoker(fn, thisWired, arg0Wired, arg1Wired, arg2Wired, arg3Wired);
        var ret = retType.fromWireType(rv);
        return ret;
        }
        
        }}break;
        case 'RenderableManager$Builder$geometryOffset': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4,argType5
        ) {
        return function RenderableManager$Builder$geometryOffset(arg0, arg1, arg2, arg3, arg4, arg5) {
        if (arguments.length !== 6) {
        throwBindingError('function RenderableManager$Builder.geometryOffset called with ' + arguments.length + ' arguments, expected 6 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // RenderableManager$PrimitiveType
        ...
        var rv = invoker(fn, thisWired, arg0Wired, arg1Wired, arg2Wired, arg3Wired, arg4Wired, arg5Wired);
        var ret = retType.fromWireType(rv);
        return ret;
        }
        
        }}break;
        case 'RenderableManager$Builder$geometryMinMax': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4,argType5,argType6,argType7
        ) {
        return function RenderableManager$Builder$geometryMinMax(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
        if (arguments.length !== 8) {
        throwBindingError('function RenderableManager$Builder.geometryMinMax called with ' + arguments.length + ' arguments, expected 8 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // RenderableManager$PrimitiveType
        ...
        var rv = invoker(fn, thisWired, arg0Wired, arg1Wired, arg2Wired, arg3Wired, arg4Wired, arg5Wired, arg6Wired, arg7Wired);
        var ret = retType.fromWireType(rv);
        return ret;
        }
        
        }}break;
        case 'RenderableManager$Builder$material': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$Builder$material(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager$Builder.material called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        ...
        case 'RenderableManager$Builder$skinning': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$skinning(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.skinning called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$Builder$blendOrder': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$Builder$blendOrder(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager$Builder.blendOrder called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        ...
        case 'RenderableManager$Builder$globalBlendOrderEnabled': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$Builder$globalBlendOrderEnabled(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager$Builder.globalBlendOrderEnabled called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        ...
        case 'RenderableManager$getPrimitiveCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$getPrimitiveCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.getPrimitiveCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$setMaterialInstanceAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setMaterialInstanceAt(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setMaterialInstanceAt called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        ...
        case 'RenderableManager$getMaterialInstanceAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$getMaterialInstanceAt(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.getMaterialInstanceAt called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned long
        ...
        case 'RenderableManager$setGeometryAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4,argType5,argType6
        ) {
        return function RenderableManager$setGeometryAt(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
        if (arguments.length !== 7) {
        throwBindingError('function RenderableManager.setGeometryAt called with ' + arguments.length + ' arguments, expected 7 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned long
        ...
        var arg5Wired = argType5.toWireType(null, arg5); // unsigned long
        var arg6Wired = argType6.toWireType(null, arg6); // unsigned long
        invoker(fn, thisWired, arg0Wired, arg1Wired, arg2Wired, arg3Wired, arg4Wired, arg5Wired, arg6Wired);
        }
        
        }}break;
        case 'RenderableManager$setBlendOrderAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setBlendOrderAt(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setBlendOrderAt called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned long
        ...
        case 'RenderableManager$setGlobalBlendOrderEnabledAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setGlobalBlendOrderEnabledAt(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setGlobalBlendOrderEnabledAt called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned long
        ...
        case 'RenderableManager$getEnabledAttributesAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$getEnabledAttributesAt(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.getEnabledAttributesAt called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned long
        ...
        case 'BufferObject$getByteCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function BufferObject$getByteCount() {
        if (arguments.length !== 0) {
        throwBindingError('function BufferObject.getByteCount called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Texture$_getWidth': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function Texture$_getWidth(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function Texture._getWidth called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'Texture$_getHeight': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function Texture$_getHeight(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function Texture._getHeight called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'Texture$_getDepth': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function Texture$_getDepth(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function Texture._getDepth called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned char
        ...
        case 'Texture$_getLevels': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Texture$_getLevels(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Texture._getLevels called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Engine*
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'MeshReader$MaterialRegistry$size': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MeshReader$MaterialRegistry$size() {
        if (arguments.length !== 0) {
        throwBindingError('function MeshReader$MaterialRegistry.size called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'SurfaceOrientation$Builder$vertexCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function SurfaceOrientation$Builder$vertexCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function SurfaceOrientation$Builder.vertexCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'SurfaceOrientation$Builder$triangleCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function SurfaceOrientation$Builder$triangleCount(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function SurfaceOrientation$Builder.triangleCount called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'SurfaceOrientation$_getQuats': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function SurfaceOrientation$_getQuats(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function SurfaceOrientation._getQuats called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // long
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned long
        ...
        case 'gltfio$Animator$getAnimationCount': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$Animator$getAnimationCount() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$Animator.getAnimationCount called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'gltfio$CTEngineInstance$attachSkin': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$CTEngineInstance$attachSkin(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$CTEngineInstance.attachSkin called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // Entity
        ...
        case 'gltfio$CTEngineInstance$detachSkin': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$CTEngineInstance$detachSkin(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$CTEngineInstance.detachSkin called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // Entity
        ...
        case 'gltfio$CTEngineInstance$applyMaterialVariant': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$CTEngineInstance$applyMaterialVariant(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$CTEngineInstance.applyMaterialVariant called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Frustum$intersectsBox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Frustum$intersectsBox(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Frustum.intersectsBox called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderableManager$Builder$boundingBox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function RenderableManager$Builder$boundingBox(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.boundingBox called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Box
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$setAxisAlignedBoundingBox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function RenderableManager$setAxisAlignedBoundingBox(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.setAxisAlignedBoundingBox called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        ...
        case 'RenderableManager$getAxisAlignedBoundingBox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$getAxisAlignedBoundingBox(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager.getAxisAlignedBoundingBox called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$CTEngineAsset$getBoundingBox': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$CTEngineAsset$getBoundingBox() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$CTEngineAsset.getBoundingBox called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$lookAt': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor,arg1Wired_dtor,arg2Wired_dtor
        ) {
        return function Camera$lookAt(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function Camera.lookAt called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Camera$getLeftVector': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getLeftVector() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getLeftVector called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getUpVector': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getUpVector() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getUpVector called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getForwardVector': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getForwardVector() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getForwardVector called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'ColorGrading$Builder$channelMixer': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor,arg1Wired_dtor,arg2Wired_dtor
        ) {
        return function ColorGrading$Builder$channelMixer(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function ColorGrading$Builder.channelMixer called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'ColorGrading$Builder$slopeOffsetPower': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor,arg1Wired_dtor,arg2Wired_dtor
        ) {
        return function ColorGrading$Builder$slopeOffsetPower(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function ColorGrading$Builder.slopeOffsetPower called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'ColorGrading$Builder$curves': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor,arg1Wired_dtor,arg2Wired_dtor
        ) {
        return function ColorGrading$Builder$curves(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function ColorGrading$Builder.curves called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'LightManager$Builder$position': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function LightManager$Builder$position(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.position called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$direction': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function LightManager$Builder$direction(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.direction called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$color': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function LightManager$Builder$color(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.color called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setPosition': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function LightManager$setPosition(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setPosition called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'LightManager$getPosition': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getPosition(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getPosition called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setDirection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function LightManager$setDirection(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setDirection called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'LightManager$getDirection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getDirection(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getDirection called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setColor': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function LightManager$setColor(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setColor called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'LightManager$getColor': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getColor(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getColor called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'CTScene$showBackground': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function CTScene$showBackground(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function CTScene.showBackground called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float3
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Renderer$_setClearOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Renderer$_setClearOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Renderer._setClearOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Frustum$getNormalizedPlane': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Frustum$getNormalizedPlane(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Frustum.getNormalizedPlane called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Frustum$intersectsSphere': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Frustum$intersectsSphere(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Frustum.intersectsSphere called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'ColorGrading$Builder$shadowsMidtonesHighlights': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,arg0Wired_dtor,arg1Wired_dtor,arg2Wired_dtor,arg3Wired_dtor
        ) {
        return function ColorGrading$Builder$shadowsMidtonesHighlights(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function ColorGrading$Builder.shadowsMidtonesHighlights called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float4
        ...
        case 'Skybox$setColor': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Skybox$setColor(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Skybox.setColor called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float4
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Skybox$Builder$color': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Skybox$Builder$color(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Skybox$Builder.color called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float4
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$_shadowOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function LightManager$Builder$_shadowOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder._shadowOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'LightManager$_setShadowOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function LightManager$_setShadowOptions(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager._setShadowOptions called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        ...
        case 'constructor$Frustum': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function constructor$Frustum(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function constructor Frustum called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        ...
        case 'Frustum$setProjection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Frustum$setProjection(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Frustum.setProjection called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // mat4
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Camera$getProjectionMatrix': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getProjectionMatrix() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getProjectionMatrix called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getCullingProjectionMatrix': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getCullingProjectionMatrix() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getCullingProjectionMatrix called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$setModelMatrix': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Camera$setModelMatrix(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Camera.setModelMatrix called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // mat4
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Camera$getModelMatrix': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getModelMatrix() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getModelMatrix called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getViewMatrix': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getViewMatrix() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getViewMatrix called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$inverseProjection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Camera$inverseProjection(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Camera.inverseProjection called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // mat4
        var rv = invoker(fn, arg0Wired);
        arg0Wired_dtor(arg0Wired); // mat4
        ...
        case 'TransformManager$setTransform': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function TransformManager$setTransform(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function TransformManager.setTransform called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // TransformManager$Instance
        ...
        case 'TransformManager$getTransform': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$getTransform(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.getTransform called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // TransformManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'TransformManager$getWorldTransform': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TransformManager$getWorldTransform(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TransformManager.getWorldTransform called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // TransformManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function multiplyMatrices(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function multiplyMatrices called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // mat4
        var arg1Wired = argType1.toWireType(null, arg1); // mat4
        var rv = invoker(fn, arg0Wired, arg1Wired);
        ...
        case 'IndirectLight$setRotation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function IndirectLight$setRotation(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight.setRotation called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'IndirectLight$getRotation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function IndirectLight$getRotation() {
        if (arguments.length !== 0) {
        throwBindingError('function IndirectLight.getRotation called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'IndirectLight$Builder$rotation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function IndirectLight$Builder$rotation(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight$Builder.rotation called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // mat3
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 3) {
        throwBindingError('function Camera.setExposure called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Camera$setExposureDirect': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Camera$setExposureDirect(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Camera.setExposureDirect called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Camera$getAperture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getAperture() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getAperture called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getShutterSpeed': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getShutterSpeed() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getShutterSpeed called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getSensitivity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getSensitivity() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getSensitivity called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$setFocusDistance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function Camera$setFocusDistance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Camera.setFocusDistance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'Camera$getFocusDistance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getFocusDistance() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getFocusDistance called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'ColorGrading$Builder$exposure': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$exposure(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.exposure called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'ColorGrading$Builder$nightAdaptation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$nightAdaptation(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.nightAdaptation called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'ColorGrading$Builder$whiteBalance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function ColorGrading$Builder$whiteBalance(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function ColorGrading$Builder.whiteBalance called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'ColorGrading$Builder$contrast': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$contrast(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.contrast called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'ColorGrading$Builder$vibrance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$vibrance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.vibrance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'ColorGrading$Builder$saturation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function ColorGrading$Builder$saturation(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function ColorGrading$Builder.saturation called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$intensity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$intensity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.intensity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$falloff': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$falloff(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.falloff called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$spotLightCone': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$Builder$spotLightCone(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager$Builder.spotLightCone called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$Builder$sunAngularRadius': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$sunAngularRadius(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.sunAngularRadius called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$sunHaloSize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$sunHaloSize(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.sunHaloSize called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$Builder$sunHaloFalloff': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$Builder$sunHaloFalloff(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager$Builder.sunHaloFalloff called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setIntensity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$setIntensity(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setIntensity called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$setIntensityEnergy': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function LightManager$setIntensityEnergy(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function LightManager.setIntensityEnergy called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$getIntensity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getIntensity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getIntensity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setFalloff': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$setFalloff(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setFalloff called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$getFalloff': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getFalloff(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getFalloff called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setSpotLightCone': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function LightManager$setSpotLightCone(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function LightManager.setSpotLightCone called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$setSunAngularRadius': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$setSunAngularRadius(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setSunAngularRadius called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$getSunAngularRadius': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getSunAngularRadius(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getSunAngularRadius called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setSunHaloSize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$setSunHaloSize(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setSunHaloSize called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$getSunHaloSize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getSunHaloSize(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getSunHaloSize called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'LightManager$setSunHaloFalloff': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function LightManager$setSunHaloFalloff(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function LightManager.setSunHaloFalloff called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'LightManager$getSunHaloFalloff': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function LightManager$getSunHaloFalloff(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function LightManager.getSunHaloFalloff called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // LightManager$Instance
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$setPolygonOffset': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function MaterialInstance$setPolygonOffset(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setPolygonOffset called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'MaterialInstance$setMaskThreshold': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setMaskThreshold(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setMaskThreshold called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$getMaskThreshold': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$getMaskThreshold() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.getMaskThreshold called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$setSpecularAntiAliasingVariance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setSpecularAntiAliasingVariance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setSpecularAntiAliasingVariance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$getSpecularAntiAliasingVariance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$getSpecularAntiAliasingVariance() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.getSpecularAntiAliasingVariance called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$setSpecularAntiAliasingThreshold': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstance$setSpecularAntiAliasingThreshold(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstance.setSpecularAntiAliasingThreshold called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstance$getSpecularAntiAliasingThreshold': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$getSpecularAntiAliasingThreshold() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.getSpecularAntiAliasingThreshold called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'TextureSampler$setAnisotropy': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function TextureSampler$setAnisotropy(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function TextureSampler.setAnisotropy called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'IndirectLight$setIntensity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndirectLight$setIntensity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight.setIntensity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'IndirectLight$getIntensity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function IndirectLight$getIntensity() {
        if (arguments.length !== 0) {
        throwBindingError('function IndirectLight.getIntensity called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'IndirectLight$Builder$intensity': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndirectLight$Builder$intensity(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight$Builder.intensity called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$Animator$applyAnimation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function gltfio$Animator$applyAnimation(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$Animator.applyAnimation called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'gltfio$Animator$applyCrossFade': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function gltfio$Animator$applyCrossFade(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function gltfio$Animator.applyCrossFade called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'gltfio$Animator$getAnimationDuration': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$Animator$getAnimationDuration(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$Animator.getAnimationDuration called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$Avatar$ShowAvatar': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$Avatar$ShowAvatar(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$Avatar.ShowAvatar called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$ResourceLoader$asyncGetLoadProgress': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function gltfio$ResourceLoader$asyncGetLoadProgress() {
        if (arguments.length !== 0) {
        throwBindingError('function gltfio$ResourceLoader.asyncGetLoadProgress called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'CTAnimator$applyAnimation': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function CTAnimator$applyAnimation(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function CTAnimator.applyAnimation called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        ...
        case 'ViewerGui$renderUserInterface': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function ViewerGui$renderUserInterface(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function ViewerGui.renderUserInterface called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var arg1Wired = argType1.toWireType(null, arg1); // View*
        ...
        case 'ViewerGui$mouseEvent': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4
        ) {
        return function ViewerGui$mouseEvent(arg0, arg1, arg2, arg3, arg4) {
        if (arguments.length !== 5) {
        throwBindingError('function ViewerGui.mouseEvent called with ' + arguments.length + ' arguments, expected 5 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // float
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        invoker(fn, thisWired, arg0Wired, arg1Wired, arg2Wired, arg3Wired, arg4Wired);
        }
        
        }}break;
        case 'fitIntoUnitCube': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function fitIntoUnitCube(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function fitIntoUnitCube called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        ...
        case 'View$_setBloomOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setBloomOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setBloomOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$_setFogOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setFogOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setFogOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$_setDepthOfFieldOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setDepthOfFieldOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setDepthOfFieldOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$_setVignetteOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setVignetteOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setVignetteOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$_setAmbientOcclusionOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setAmbientOcclusionOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setAmbientOcclusionOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$_setTemporalAntiAliasingOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setTemporalAntiAliasingOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setTemporalAntiAliasingOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'View$_setScreenSpaceReflectionsOptions': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function View$_setScreenSpaceReflectionsOptions(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function View._setScreenSpaceReflectionsOptions called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Camera$setScaling': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Camera$setScaling(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Camera.setScaling called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Camera$getPosition': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getPosition() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getPosition called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getScaling': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getScaling() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getScaling called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$setProjection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4,argType5,argType6
        ) {
        return function Camera$setProjection(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
        if (arguments.length !== 7) {
        throwBindingError('function Camera.setProjection called with ' + arguments.length + ' arguments, expected 7 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Camera$setProjectionFov': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4
        ) {
        return function Camera$setProjectionFov(arg0, arg1, arg2, arg3, arg4) {
        if (arguments.length !== 5) {
        throwBindingError('function Camera.setProjectionFov called with ' + arguments.length + ' arguments, expected 5 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'Camera$setLensProjection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3
        ) {
        return function Camera$setLensProjection(arg0, arg1, arg2, arg3) {
        if (arguments.length !== 4) {
        throwBindingError('function Camera.setLensProjection called with ' + arguments.length + ' arguments, expected 4 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // double
        var arg1Wired = argType1.toWireType(null, arg1); // double
        ...
        case 'Camera$setCustomProjection': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor
        ) {
        return function Camera$setCustomProjection(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function Camera.setCustomProjection called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // mat4
        var arg1Wired = argType1.toWireType(null, arg1); // double
        ...
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getNear called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getCullingFar': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getCullingFar() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getCullingFar called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$getFocalLength': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Camera$getFocalLength() {
        if (arguments.length !== 0) {
        throwBindingError('function Camera.getFocalLength called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'Camera$computeEffectiveFocalLength': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function Camera$computeEffectiveFocalLength(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function Camera.computeEffectiveFocalLength called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // double
        var arg1Wired = argType1.toWireType(null, arg1); // double
        var rv = invoker(fn, arg0Wired, arg1Wired);
        ...
        case 'Camera$computeEffectiveFov': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function Camera$computeEffectiveFov(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function Camera.computeEffectiveFov called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // double
        var arg1Wired = argType1.toWireType(null, arg1); // double
        var rv = invoker(fn, arg0Wired, arg1Wired);
        ...
        case 'RegistryKeys$push_back': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function RegistryKeys$push_back(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RegistryKeys.push_back called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RegistryKeys$resize': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function RegistryKeys$resize(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RegistryKeys.resize called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        ...
        case 'RegistryKeys$set': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function RegistryKeys$set(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RegistryKeys.set called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'Material$createNamedInstance': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Material$createNamedInstance(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Material.createNamedInstance called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'Material$getName': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function Material$getName() {
        if (arguments.length !== 0) {
        throwBindingError('function Material.getName called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$getName': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function MaterialInstance$getName() {
        if (arguments.length !== 0) {
        throwBindingError('function MaterialInstance.getName called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MaterialInstance$setBoolParameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function MaterialInstance$setBoolParameter(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setBoolParameter called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // bool
        ...
        case 'MaterialInstance$setFloatParameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function MaterialInstance$setFloatParameter(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setFloatParameter called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // float
        ...
        case 'MaterialInstance$setFloat2Parameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function MaterialInstance$setFloat2Parameter(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setFloat2Parameter called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        ...
        case 'MaterialInstance$setFloat3Parameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function MaterialInstance$setFloat3Parameter(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setFloat3Parameter called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        ...
        case 'MaterialInstance$setFloat4Parameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function MaterialInstance$setFloat4Parameter(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MaterialInstance.setFloat4Parameter called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // float4
        ...
        case 'MaterialInstance$setTextureParameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor
        ) {
        return function MaterialInstance$setTextureParameter(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function MaterialInstance.setTextureParameter called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // Texture*
        ...
        case 'MaterialInstance$setColor3Parameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor,arg2Wired_dtor
        ) {
        return function MaterialInstance$setColor3Parameter(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function MaterialInstance.setColor3Parameter called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        ...
        case 'MaterialInstance$setColor4Parameter': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,arg0Wired_dtor,arg2Wired_dtor
        ) {
        return function MaterialInstance$setColor4Parameter(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function MaterialInstance.setColor4Parameter called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        ...
        case 'Ktx1Bundle$getMetadata': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function Ktx1Bundle$getMetadata(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function Ktx1Bundle.getMetadata called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'MeshReader$MaterialRegistry$set': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function MeshReader$MaterialRegistry$set(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function MeshReader$MaterialRegistry.set called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // MaterialInstance*
        ...
        case 'gltfio$Animator$getAnimationName': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$Animator$getAnimationName(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$Animator.getAnimationName called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$Avatar$Init': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function gltfio$Avatar$Init(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$Avatar.Init called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'gltfio$Avatar$ProcessTTS': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function gltfio$Avatar$ProcessTTS(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$Avatar.ProcessTTS called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'gltfio$Avatar$PlayNonStreamingFile': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor,arg1Wired_dtor
        ) {
        return function gltfio$Avatar$PlayNonStreamingFile(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$Avatar.PlayNonStreamingFile called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'gltfio$Avatar$writeFile': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function gltfio$Avatar$writeFile(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$Avatar.writeFile called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'gltfio$Avatar$StartPlayStreamingTTS': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2,argType3,argType4,argType5,argType6,arg0Wired_dtor,arg1Wired_dtor,arg3Wired_dtor
        ) {
        return function gltfio$Avatar$StartPlayStreamingTTS(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
        if (arguments.length !== 7) {
        throwBindingError('function gltfio$Avatar.StartPlayStreamingTTS called with ' + arguments.length + ' arguments, expected 7 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'gltfio$Avatar$setVoice': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function gltfio$Avatar$setVoice(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$Avatar.setVoice called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$FileLoader$loadSettings': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function gltfio$FileLoader$loadSettings(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$FileLoader.loadSettings called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // ViewerGui*
        ...
        case 'gltfio$FileLoader$_loadFile': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function gltfio$FileLoader$_loadFile(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$FileLoader._loadFile called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // driver$BufferDescriptor
        var arg1Wired = argType1.toWireType(null, arg1); // std::string
        ...
        case 'gltfio$CTEngineAsset$_getEntitiesByName': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function gltfio$CTEngineAsset$_getEntitiesByName(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$CTEngineAsset._getEntitiesByName called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$CTEngineAsset$_getEntitiesByPrefix': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function gltfio$CTEngineAsset$_getEntitiesByPrefix(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$CTEngineAsset._getEntitiesByPrefix called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$CTEngineAsset$getFirstEntityByName': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function gltfio$CTEngineAsset$getFirstEntityByName(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$CTEngineAsset.getFirstEntityByName called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$CTEngineAsset$getName': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$CTEngineAsset$getName(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$CTEngineAsset.getName called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$CTEngineAsset$getExtras': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function gltfio$CTEngineAsset$getExtras(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$CTEngineAsset.getExtras called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // Entity
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'gltfio$ResourceLoader$addResourceData': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function gltfio$ResourceLoader$addResourceData(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$ResourceLoader.addResourceData called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var arg1Wired = argType1.toWireType(null, arg1); // driver$BufferDescriptor
        ...
        case 'gltfio$ResourceLoader$addStbProvider': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function gltfio$ResourceLoader$addStbProvider(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$ResourceLoader.addStbProvider called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        ...
        case 'gltfio$ResourceLoader$addKtx2Provider': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg0Wired_dtor
        ) {
        return function gltfio$ResourceLoader$addKtx2Provider(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function gltfio$ResourceLoader.addKtx2Provider called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        ...
        case 'gltfio$ResourceLoader$hasResourceData': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function gltfio$ResourceLoader$hasResourceData(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function gltfio$ResourceLoader.hasResourceData called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'CTScene$setTexture': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function CTScene$setTexture(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function CTScene.setTexture called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'JsonSerializer$writeJson': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function JsonSerializer$writeJson(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function JsonSerializer.writeJson called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RegistryKeys$get': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RegistryKeys$get(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RegistryKeys.get called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'EntityVector$get': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function EntityVector$get(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function EntityVector.get called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'AssetInstanceVector$get': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function AssetInstanceVector$get(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function AssetInstanceVector.get called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'MaterialInstanceVector$get': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function MaterialInstanceVector$get(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MaterialInstanceVector.get called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned long
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        if (arguments.length !== 3) {
        throwBindingError('function View.pick called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned int
        var arg1Wired = argType1.toWireType(null, arg1); // unsigned int
        ...
        case 'RenderableManager$Builder$skinningBones': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$skinningBones(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.skinningBones called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        ...
        case 'RenderableManager$Builder$skinningMatrices': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function RenderableManager$Builder$skinningMatrices(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function RenderableManager$Builder.skinningMatrices called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // emscripten::val
        var rv = invoker(fn, thisWired, arg0Wired);
        ...
        case 'RenderableManager$setBones': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setBones(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setBones called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        ...
        case 'RenderableManager$setBonesFromMatrices': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,argType2
        ) {
        return function RenderableManager$setBonesFromMatrices(arg0, arg1, arg2) {
        if (arguments.length !== 3) {
        throwBindingError('function RenderableManager.setBonesFromMatrices called with ' + arguments.length + ' arguments, expected 3 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // emscripten::val
        ...
        case 'RenderableManager$setMorphWeights': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function RenderableManager$setMorphWeights(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function RenderableManager.setMorphWeights called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // RenderableManager$Instance
        var arg1Wired = argType1.toWireType(null, arg1); // emscripten::val
        ...
        case 'IndirectLight$getDirectionEstimate': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0
        ) {
        return function IndirectLight$getDirectionEstimate(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function IndirectLight.getDirectionEstimate called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // emscripten::val
        var rv = invoker(fn, arg0Wired);
        var ret = retType.fromWireType(rv);
        ...
        case 'IndirectLight$getColorEstimate': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1,arg1Wired_dtor
        ) {
        return function IndirectLight$getColorEstimate(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function IndirectLight.getColorEstimate called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var arg0Wired = argType0.toWireType(null, arg0); // emscripten::val
        var arg1Wired = argType1.toWireType(null, arg1); // float3
        var rv = invoker(fn, arg0Wired, arg1Wired);
        ...
        case 'IndirectLight$Builder$irradianceSh': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,argType1
        ) {
        return function IndirectLight$Builder$irradianceSh(arg0, arg1) {
        if (arguments.length !== 2) {
        throwBindingError('function IndirectLight$Builder.irradianceSh called with ' + arguments.length + ' arguments, expected 2 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // unsigned char
        var arg1Wired = argType1.toWireType(null, arg1); // emscripten::val
        ...
        case 'driver$BufferDescriptor$getBytes': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function driver$BufferDescriptor$getBytes() {
        if (arguments.length !== 0) {
        throwBindingError('function driver$BufferDescriptor.getBytes called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'driver$PixelBufferDescriptor$getBytes': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam
        ) {
        return function driver$PixelBufferDescriptor$getBytes() {
        if (arguments.length !== 0) {
        throwBindingError('function driver$PixelBufferDescriptor.getBytes called with ' + arguments.length + ' arguments, expected 0 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var rv = invoker(fn, thisWired);
        var ret = retType.fromWireType(rv);
        ...
        case 'MeshReader$MaterialRegistry$get': {
        return function anonymous(throwBindingError,invoker,fn,runDestructors,retType,classParam,argType0,arg0Wired_dtor
        ) {
        return function MeshReader$MaterialRegistry$get(arg0) {
        if (arguments.length !== 1) {
        throwBindingError('function MeshReader$MaterialRegistry.get called with ' + arguments.length + ' arguments, expected 1 args!');
        }
        var thisWired = classParam.toWireType(null, this);
        var arg0Wired = argType0.toWireType(null, arg0); // std::string
        var rv = invoker(fn, thisWired, arg0Wired);
...
CTEngine.Buffer = function (typedarray) {
  if(!(typedarray.buffer instanceof ArrayBuffer))
    console.error(typedarray.buffer instanceof ArrayBuffer);
  //console.assert(typedarray.buffer instanceof ArrayBuffer);
  if(!(typedarray.byteLength > 0))
    console.error(typedarray.byteLength > 0);
